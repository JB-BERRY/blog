  ...
  return (
    <>
      ...
      <main className="min-h-screen max-w-6xl mx-auto p-8">
        ...
        title={
            <>
                Stripe <span className="text-blue-500">API</span>
            </>
        }
        content="The Stripe API is powerful. Learn how to use it to build your own payment system. Webhooks, Restricted API keys, and more."
        />
        <GridCategory
         sectionTitle="Most recent articles in Stripe API"
         articles={articles}
        />
        <BrowseSection
